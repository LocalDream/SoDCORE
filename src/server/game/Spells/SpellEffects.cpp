...
void Spell::EffectDummy(SpellEffIndex effIndex)
{
    ...
    //START OF THE MASTERY SPELLS//
    switch(m_spellInfo->Id)
    {
        case 87492: // Death Knight Mastery - fixed
        {
            // Blood. -- FIXED
            if (unitTarget->HasAura(50034)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77513, false); // Blood Shield.
                unitTarget->ToPlayer()->removeSpell(77515, true); // Dreadblade.
                unitTarget->ToPlayer()->removeSpell(77514, true); // Frozen Heart.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77513,true);
            }
            // Frost. -- FIXED
            if (unitTarget->HasAura(50887)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77514, false); // Frozen Heart.
                unitTarget->ToPlayer()->removeSpell(77515, true); // Dreadblade.
                unitTarget->ToPlayer()->removeSpell(77513, true); // Blood Shield.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77514,true);
            }
            // Unholy. -- FIXED
            if (unitTarget->HasAura(52143)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77515, false); // Dreadblade.
                unitTarget->ToPlayer()->removeSpell(77514, true); // Frozen Heart.
                unitTarget->ToPlayer()->removeSpell(77513, true); // Blood Shield.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77515,true);
            }
            break;
        }
        case 87491: // Druid Mastery
        {
            // Balance. -- FIXED
            if (unitTarget->HasAura(16913)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77492, false); // Total Eclipse.
                unitTarget->ToPlayer()->removeSpell(77493, true); // Razor Claws.
                unitTarget->ToPlayer()->removeSpell(77494, true); // Savage Defender.
                unitTarget->ToPlayer()->removeSpell(77495, true); // Symbiosis.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77492,true);
            }
            // Feral Combat. -- FIXED
            if (unitTarget->HasAura(84735)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77494, false); // Savage Defender.
                unitTarget->ToPlayer()->learnSpell(77493, false); // Razor Claws.
                unitTarget->ToPlayer()->removeSpell(77492, true); // Total Eclipse.
                unitTarget->ToPlayer()->removeSpell(77495, true); // Symbiosis.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77494,true);
                unitTarget->ToPlayer()->CastSpell(unitTarget,77493,true);
            }
            // Restoration. -- FIXED
            if (unitTarget->HasAura(87305)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77495, false); // Symbiosis.
                unitTarget->ToPlayer()->removeSpell(77493, true); // Razor Claws.
                unitTarget->ToPlayer()->removeSpell(77494, true); // Savage Defender.
                unitTarget->ToPlayer()->removeSpell(77492, true); // Total Eclipse.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77495,true);
            }
            break;
        }
        case 87493: // Hunter Mastery
        {
            // Beast Mastery. -- FIXED
            if (unitTarget->HasAura(87325)) // One of Branch spells. - fixed
            {
                unitTarget->ToPlayer()->learnSpell(76657, false); // Master of Beasts.
                unitTarget->ToPlayer()->removeSpell(76659, true); // Wild Quiver.
                unitTarget->ToPlayer()->removeSpell(76658, true); // Essence of the Viper.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76657,true);
            }
            // Marksmanship. -- FIXED
            if (unitTarget->HasAura(87326)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76659, false); // Wild Quiver.
                unitTarget->ToPlayer()->removeSpell(76657, true); // Master of Beasts.
                unitTarget->ToPlayer()->removeSpell(76658, true); // Essence of the Viper.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76659,true);
            }
            // Survival. -- FIXED
            if (unitTarget->HasAura(84729)) // One of Branch spells. - fixed
            {
                unitTarget->ToPlayer()->learnSpell(76658, false); // Essence of the Viper.
                unitTarget->ToPlayer()->removeSpell(76657, true); // Master of Beasts.
                unitTarget->ToPlayer()->removeSpell(76659, true); // Wild Quiver.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76658,true);
            }
            break;
        }
        case 86467: // Mage Mastery
        {
            // Arcane. -- FIXED
            if (unitTarget->HasAura(84671)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76547, false); // Mana Adept.
                unitTarget->ToPlayer()->removeSpell(76595, true); // Flashburn.
                unitTarget->ToPlayer()->removeSpell(76613, true); // Frostburn.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76547,true);
            }
            // Fire. -- FIXED
            if (unitTarget->HasAura(84668)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76595, false); // Flashburn.
                unitTarget->ToPlayer()->removeSpell(76547, true); // Mana Adept.
                unitTarget->ToPlayer()->removeSpell(76613, true); // Frostburn.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76595,true);
            }
            // Frost.
            if (unitTarget->HasAura(84669)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76613, false); // Frostburn.
                unitTarget->ToPlayer()->removeSpell(76547, true); // Mana Adept.
                unitTarget->ToPlayer()->removeSpell(76595, true); // Flashburn.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76613,true);
            }
            break;
        }
        case 87494: // Paladin Mastery
        {
            // Holy. -- FIXED
            if (unitTarget->HasAura(85102)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76669, false); // Illuminated Healing.
                unitTarget->ToPlayer()->removeSpell(76671, true); // Divine Bulwark.
                unitTarget->ToPlayer()->removeSpell(76672, true); // Hand of Light.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76669,true);
            }
            // Protection. -- FIXED
            if (unitTarget->HasAura(84839)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76671, false); // Divine Bulwark.
                unitTarget->ToPlayer()->removeSpell(76669, true); // Illuminated Healing.
                unitTarget->ToPlayer()->removeSpell(76672, true); // Hand of Light.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76671,true);
            }
            // Retribution.
            if (unitTarget->HasAura(20113)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76672, false); // Hand of Light.
                unitTarget->ToPlayer()->removeSpell(76669, true); // Illuminated Healing.
                unitTarget->ToPlayer()->removeSpell(76671, true); // Divine Bulwark.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76672,true);
            }
            break;
        }
        case 87495: // Priest Mastery
        {
            // Discipline.
            if (unitTarget->HasAura(84732)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77484, false); // Shield Discipline.
                unitTarget->ToPlayer()->removeSpell(77485, true); // Echo of Light.
                unitTarget->ToPlayer()->removeSpell(77486, true); // Shadow Orb Power.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77484,true);
            }
            // Holy. -- FIXED
            if (unitTarget->HasAura(87336)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77485, false); // Echo of Light.
                unitTarget->ToPlayer()->removeSpell(77484, true); // Shield Discipline.
                unitTarget->ToPlayer()->removeSpell(77486, true); // Shadow Orb Power.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77485,true);
            }
            // Shadow. -- FIXED
            if (unitTarget->HasAura(87327)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77486, false); // Shadow Orb Power.
                unitTarget->ToPlayer()->removeSpell(77484, true); // Shield Discipline.
                unitTarget->ToPlayer()->removeSpell(77485, true); // Echo of Light.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77486,true);
            }
            break;
        }
        case 87496: // Rogue Mastery
        {
            // Assassination. -- FIXED
            if (unitTarget->HasAura(14117)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76803, false); // Potent Poisons.
                unitTarget->ToPlayer()->removeSpell(76806, true); // Main Gauche.
                unitTarget->ToPlayer()->removeSpell(76808, true); // Executioner.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76803,true);
            }
            // Combat.
            if (unitTarget->HasAura(61329)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76806, false); // Main Gauche.
                unitTarget->ToPlayer()->removeSpell(76803, true); // Potent Poisons.
                unitTarget->ToPlayer()->removeSpell(76808, true); // Executioner.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76806,true);
            }
            // Subtlety. -- FIXED
            if (unitTarget->HasAura(31220)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76808, false); // Executioner.
                unitTarget->ToPlayer()->removeSpell(76803, true); // Potent Poisons.
                unitTarget->ToPlayer()->removeSpell(76806, true); // Main Gauche.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76808,true);
            }
            break;
        }
        case 87497: // Shaman Mastery
        {
            // Elemental. -- FIXED
            if (unitTarget->HasAura(62099)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77222, false); // Elemental Overload.
                unitTarget->ToPlayer()->removeSpell(77223, true); // Enhanced Elements.
                unitTarget->ToPlayer()->removeSpell(77226, true); // Deep Healing.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77222,true);
            }
            // Enhancement. -- FIXED
            if (unitTarget->HasAura(86629)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77223, false); // Enhanced Elements.
                unitTarget->ToPlayer()->removeSpell(77222, true); // Elemental Overload.
                unitTarget->ToPlayer()->removeSpell(77226, true); // Deep Healing.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77223,true);
            }
            // Restoration. -- FIXED
            if (unitTarget->HasAura(16213)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77226, false); // Deep Healing.
                unitTarget->ToPlayer()->removeSpell(77222, true); // Elemental Overload.
                unitTarget->ToPlayer()->removeSpell(77223, true); // Enhanced Elements.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77226,true);
            }
            break;
        }
        case 87498: // Warlock Mastery
        {
            // Affliction. -- FIXED
            if (unitTarget->HasAura(87339)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77215, false); // Potent Afflictions.
                unitTarget->ToPlayer()->removeSpell(77219, true); // Master Demonologist.
                unitTarget->ToPlayer()->removeSpell(77220, true); // Fiery Apocalypse.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77215,true);
            }
            // Demonology. -- FIXED
            if (unitTarget->HasAura(84740)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77219, false); // Master Demonologist.
                unitTarget->ToPlayer()->removeSpell(77215, true); // Potent Afflictions.
                unitTarget->ToPlayer()->removeSpell(77220, true); // Fiery Apocalypse.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77219,true);
            }
            // Destruction. -- FIXED
            if (unitTarget->HasAura(84739)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(77220, false); // Fiery Apocalypse.
                unitTarget->ToPlayer()->removeSpell(77215, true); // Potent Afflictions.
                unitTarget->ToPlayer()->removeSpell(77219, true); // Master Demonologist.
                unitTarget->ToPlayer()->CastSpell(unitTarget,77220,true);
            }
            break;
        }
        case 87500: // Warrior Mastery
        {
            // Arms. -- FIXED
            if (unitTarget->HasAura(12712)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76838, false); // Strikes of Opportunity.
                unitTarget->ToPlayer()->removeSpell(76856, true); // Unshackled Fury.
                unitTarget->ToPlayer()->removeSpell(76857, true); // Critical Block.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76838,true);
            }
            // Fury. -- FIXED
            if (unitTarget->HasAura(23588)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76856, false); // Unshackled Fury.
                unitTarget->ToPlayer()->removeSpell(76838, true); // Strikes of Opportunity.
                unitTarget->ToPlayer()->removeSpell(76857, true); // Critical Block.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76856,true);
            }
            // Protection. -- FIXED
            if (unitTarget->HasAura(93098)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(76857, false); // Critical Block.
                unitTarget->ToPlayer()->removeSpell(76838, true); // Strikes of Opportunity.
                unitTarget->ToPlayer()->removeSpell(76856, true); // Unshackled Fury.
                unitTarget->ToPlayer()->CastSpell(unitTarget,76857,true);
            }
            break;
        }
        // END OF THE MASTERY SPELLS//
    }

    //START OF THE SPECIALIZATION SPELLS//
    switch(m_spellInfo->Id)
    {
        case 87510: // Death Knight Specialization
        {
            // Blood.
            if (unitTarget->HasAura(50034)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86537, false);
                unitTarget->ToPlayer()->removeSpell(86113, true);
                unitTarget->ToPlayer()->removeSpell(86536, true);
            }
            // Frost.
            if (unitTarget->HasAura(50887)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86536, false);
                unitTarget->ToPlayer()->removeSpell(86113, true);
                unitTarget->ToPlayer()->removeSpell(86537, true);
            }
            // Unholy.
            if (unitTarget->HasAura(52143)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86113, false);
                unitTarget->ToPlayer()->removeSpell(86536, true);
                unitTarget->ToPlayer()->removeSpell(86537, true);
            }
            break;
        }
        case 87505: // Druid Specialization
        {
            // Balance.
            if (unitTarget->HasAura(16913)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86093, false);
                unitTarget->ToPlayer()->removeSpell(86097, true);
                unitTarget->ToPlayer()->removeSpell(86096, true);
                unitTarget->ToPlayer()->removeSpell(86104, true);
            }
            // Feral Combat.
            if (unitTarget->HasAura(84735)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86096, false);
                unitTarget->ToPlayer()->learnSpell(86097, false);
                unitTarget->ToPlayer()->removeSpell(86093, true);
                unitTarget->ToPlayer()->removeSpell(86104, true);
            }
            // Restoration.
            if (unitTarget->HasAura(87305)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86104, false);
                unitTarget->ToPlayer()->removeSpell(86097, true);
                unitTarget->ToPlayer()->removeSpell(86096, true);
                unitTarget->ToPlayer()->removeSpell(86093, true);
            }
        ...
        case 87506: // Hunter Specialization
        {
            unitTarget->ToPlayer()->learnSpell(86538, false);
            break;
        }
        case 87511: // Paladin Specialization
        {
            // Holy.
            if (unitTarget->HasAura(85102)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86103, false);
                unitTarget->ToPlayer()->removeSpell(86102, true);
                unitTarget->ToPlayer()->removeSpell(86539, true);
            }
            // Protection.
            if (unitTarget->HasAura(84839)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86102, false);
                unitTarget->ToPlayer()->removeSpell(86103, true);
                unitTarget->ToPlayer()->removeSpell(86539, true);
            }
            // Retribution.
            if (unitTarget->HasAura(20113)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86539, false);
                unitTarget->ToPlayer()->removeSpell(86103, true);
                unitTarget->ToPlayer()->removeSpell(86102, true);
            }
            break;
        }
        case 87504: // Rogue Specialization
        {
            unitTarget->ToPlayer()->learnSpell(86531, false);
            break;
        }
        case 87507: // Shaman Specialization
        {
            // Elemental.
            if (unitTarget->HasAura(62099)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86100, false);
                unitTarget->ToPlayer()->removeSpell(86099, true);
                unitTarget->ToPlayer()->removeSpell(86108, true);
            }
            // Enhancement.
            if (unitTarget->HasAura(86629)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86099, false);
                unitTarget->ToPlayer()->removeSpell(86100, true);
                unitTarget->ToPlayer()->removeSpell(86108, true);
            }
            // Restoration.
            if (unitTarget->HasAura(16213)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86108, false);
                unitTarget->ToPlayer()->removeSpell(86100, true);
                unitTarget->ToPlayer()->removeSpell(86099, true);
            }
            break;
        }
        case 87509: // Warrior Specialization
        {
            // Arms.
            if (unitTarget->HasAura(12712)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86101, false);
                unitTarget->ToPlayer()->removeSpell(86110, true);
                unitTarget->ToPlayer()->removeSpell(86535, true);
            }
            // Fury.
            if (unitTarget->HasAura(23588)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86110, false);
                unitTarget->ToPlayer()->removeSpell(86101, true);
                unitTarget->ToPlayer()->removeSpell(86535, true);
            }
            // Protection.
            if (unitTarget->HasAura(93098)) // One of Branch spells.
            {
                unitTarget->ToPlayer()->learnSpell(86535, false);
                unitTarget->ToPlayer()->removeSpell(86101, true);
                unitTarget->ToPlayer()->removeSpell(86110, true);
            }
            break;
        }
        // END OF THE SPECIALIZATION SPELLS//
    }

    if(m_spellInfo->Id == 84101) // Deepholme teleport spell
        m_caster->ToPlayer()->TeleportTo(646, 999.117004f, 525.450989f, -49.334599f, 2.986810f, 0);

    if(m_spellInfo->Id == 79614)
        if(Creature* slainspirit = m_caster->SummonCreature(42757,unitTarget->GetPositionX(),unitTarget->GetPositionY(),unitTarget->GetPositionZ(),unitTarget->GetOrientation(), TEMPSUMMON_CORPSE_DESPAWN, 1000))
            slainspirit->AI()->SetData(1, m_caster->GetGUID());

    if(m_spellInfo->Id == 71898)
        m_caster->ToPlayer()->CompleteQuest(24861);

    if(m_spellInfo->Id == 45524) // Chains of Ice
    {
        if(m_caster->HasAura(50040)) // Chilblains rank 1
            m_caster->CastSpell(unitTarget,96293,true);
        if(m_caster->HasAura(50041)) // Chilblains rank 2
        ...
        if(m_caster->HasAura(51160)) // Ebon Plaguebringer rank 2
        {
            int32 bp = 30;
            m_caster->CastCustomSpell(unitTarget,40515,&bp,NULL,NULL,true);
        }
        if(m_caster->HasAura(51099)) // Ebon Plaguebringer rank 1
        {
            int32 bp = 15;
            m_caster->CastCustomSpell(unitTarget,40515,&bp,NULL,NULL,true);
        }
    ...
    // Mage conjure refreshment
    // This could be done via spellscript
    if(m_spellInfo->Id == 42955)
    {
        //Conjures different food per level
        // A lot of spells and checks
        uint32 plrlevel = m_caster->ToPlayer()->getLevel();

        if(plrlevel >= 38 && plrlevel <= 43)
            m_caster->CastSpell(m_caster,92739,true); // Conjured Mana Cookie

        else if(plrlevel >= 44 && plrlevel <= 53)
            m_caster->CastSpell(m_caster,92799,true); // Conjured Mana Brownie

        else if(plrlevel >= 54 && plrlevel <= 63)
            m_caster->CastSpell(m_caster,92802,true); // Conjured Mana Cupcake

        else if(plrlevel >= 64 && plrlevel <= 73)
            m_caster->CastSpell(m_caster,92805,true); // Conjured Mana Lollipop

        else if(plrlevel >= 74 && plrlevel <= 79)
            m_caster->CastSpell(m_caster,74625,true); // Conjured Mana Pie

        else if(plrlevel >= 80 && plrlevel <= 84)
            m_caster->CastSpell(m_caster,42956,true); // Conjured Mana Strudel

        else if(plrlevel >= 85)
            m_caster->CastSpell(m_caster,92727,true); // Conjured Mana Cake
    }
        ...
        case SPELLFAMILY_SHAMAN:
            ...
            /*if (m_spellInfo->SpellFamilyFlags[0] & SPELLFAMILYFLAG_SHAMAN_HEALING_STREAM)
            {
                ...
                if (Unit *owner = m_caster->GetOwner())
                    if (AuraEffect *dummy = owner->GetAuraEffect(SPELL_AURA_DUMMY, SPELLFAMILY_SHAMAN, 2011, 0))
                        damage += int32(damage * dummy->GetAmount());
            ...
            if (m_spellInfo->Id == 60103)
            {
                ...
                // Improved Lava Lash
                if (m_caster->HasAura(77700))
                {
                    if (Aura* sf = unitTarget->GetAura(77661))
                    {
                        AddPct(damage, 10 * sf->GetStackAmount());
                        unitTarget->RemoveAurasDueToSpell(77661);
                    }
                }
                if (m_caster->HasAura(77701))
                {
                    if (Aura* sf = unitTarget->GetAura(77661))
                    {
                        AddPct(damage, 20 * sf->GetStackAmount());
                        unitTarget->RemoveAurasDueToSpell(77661);
                    }
                }
            }
